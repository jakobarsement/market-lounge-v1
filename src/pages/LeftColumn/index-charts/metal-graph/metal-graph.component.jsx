...
export const MetalGraph = () => {
  const formatData = (jsondata) => {
    ...
    return data.map((points) => [new Date(points[0]).getTime(), points[1]]).reverse()
  }
  ...
  return <HighchartsReact highcharts={Highcharts} options={stockOptions} constructorType="stockChart" />
}
