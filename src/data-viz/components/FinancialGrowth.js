...
export const FinancialGrowth = ({ company }) => {
    ...
    return (
        <React.Fragment>
            <IntensityBar key="revenueGrowth" company={company} indicator="revenueGrowth" title="Q/Q Revenue Growth Timeline" chartData={data} />
            <IntensityBar key="ebitgrowth" company={company} indicator="ebitgrowth" title="Q/Q EBIT Growth Timeline" chartData={data} />
        </React.Fragment>
    )
}
